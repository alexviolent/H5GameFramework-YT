...
* name;
*/
var IndexMediator = /** @class */ (function (_super) {
    __extends(IndexMediator, _super);
    function IndexMediator() {
        return _super.call(this, IndexMediator.NAME, AppContextMediator.scene) || this;
    }
    IndexMediator.prototype.onCreateResourceLoader = function () {
        return new core.ViewResourceLoader(ui.indexUI.uiView);
    };
    IndexMediator.prototype.onCreateView = function () {
    ...
    IndexMediator.prototype.onStart = function () {
